...
3. Скачать и установить Питон: https://www.python.org/downloads/
4. Установить Питон зависимости:
   pip install argparse
   pip install requests
5. Запустить скрипт с параметрами:
   fleep_cleaner.py -e MyEmail@gmail.com -p MyPassword -f data.json -s 70
   где
   -e/--email — имя пользователя во Флип
   -p/--password — пароль пользователя во Флип
   -f/-file — экспортный файл из Флип
   -s/--size — размер файла в МБ
6. Файл выдаст список файлов на удаление и их суммарный размер
7. Нужно напечатать "y", чтобы удалить эти файлы или "n", чтобы не удалять
"""
